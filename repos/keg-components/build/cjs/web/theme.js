...
var containedStyles = function containedStyles(state, colorType) {
  ...
  var activeColor = jsutils.get(colors.colors, "surface.".concat(colorType, ".colors.").concat(shade));
  return {
    main: {
      $all: {
        borderWidth: 0,
    ...
    content: {
      color: state === 'disabled' ? jsutils.get(colors.colors, 'opacity._50') : jsutils.get(colors.colors, 'palette.white01'),
      fontSize: 14,
      fontWeight: '500',
      letterSpacing: 0.5,
      textAlign: 'center',
...
var defaults$1 = colors.getThemeDefaults();
var textStyle = function textStyle(state, colorType) {
  ...
  return {
    main: {
      $all: {
        backgroundColor: state === 'hover' ? colors.colors.opacity(10, activeColor) : jsutils.get(colors.colors, 'palette.transparent')
      }
    },
    content: {
      $all: {
...
var defaults$2 = colors.getThemeDefaults();
var outlineStyles = function outlineStyles(state, colorType) {
  var stateShade = defaults$2.states.types[state].shade;
  var activeColor = jsutils.get(colors.colors, "surface.".concat(colorType, ".colors.").concat(stateShade));
  return {
    main: {
      $all: {
        padding: 8,
        ...
        backgroundColor: state === 'hover' ? colors.colors.opacity(10, activeColor) : jsutils.get(colors.colors, 'palette.white01')
      },
      $web: {
        outline: 'none'
      }
...
var defaults$3 = colors.getThemeDefaults();
...
var background = function background(color) {
  return {
    backgroundColor: colors.colors[color] || color || ''
  };
};
...
var color = function color(_color) {
  return colors.colors[_color] ? {
    color: colors.colors[_color]
  } : {
    color: _color
  };
};
...
var defaults$4 = colors.getThemeDefaults();
...
var defaults$5 = colors.getThemeDefaults();
...
var opacity05 = jsutils.get(colors.colors, 'opacity._5');
var colorPalette = jsutils.get(colors.colors, 'palette');
var section = {
  ...
  text: {
    fontSize: 22,
    lineHeight: 26,
    color: jsutils.get(colors.colors, 'opacity._65'),
    fontWeight: 'bold'
  },
  noBorder: {
    main: {
  ...
  content: {
    ...
    callout: {
      title: {
        ...
        color: jsutils.get(colors.colors, 'opacity._40'),
        fontWeight: '800'
      },
      subtitle: {
        fontSize: 13,
...
var divider = {
  $all: {
    width: '100%',
    backgroundColor: colors.colors.opacity._15,
    marginBottom: margin.size,
...
var colorPalette$1 = jsutils.get(colors.colors, 'palette');
var image = {
  default: {
    container: {
      $all: {
...
var indicator = {
  default: {
    container: container,
    icon: {
      color: jsutils.get(colors.colors, 'surface.default.colors.main')
    }
  },
  primary: {
    container: container,
    icon: {
      color: jsutils.get(colors.colors, 'surface.primary.colors.main')
    }
  },
  secondary: {
    container: container,
    icon: {
      color: jsutils.get(colors.colors, 'surface.secondary.colors.main')
    }
  },
  warn: {
    container: container,
    icon: {
      color: jsutils.get(colors.colors, 'surface.warn.colors.main')
    }
  },
  danger: {
    container: container,
    icon: {
      color: jsutils.get(colors.colors, 'surface.danger.colors.main')
    }
  }
};
...
var link = {
  default: {
    $all: {
      color: colors.colors.palette.blue01,
      textDecorationLine: 'underline',
      textDecorationColor: colors.colors.palette.blue02
    }
  },
  hover: {
    $all: {
      color: colors.colors.palette.blue02,
      textDecorationColor: colors.colors.palette.blue02
    }
  }
};

var colorPalette$2 = jsutils.get(colors.colors, 'palette');
var styles = {
  main: {
    position: 'relative'
  },
...
var section$1 = {
  default: {
    $native: {
      shadowColor: colors.colors.opacity._05,
      shadowOffset: {
        height: 0,
        width: 0
      },
    ...
    $web: {
      boxShadow: "1px 1px 5px ".concat(colors.colors.opacity._05)
    },
    $all: {
      backgroundColor: colors.colors.palette.white01,
      borderColor: colors.colors.palette.gray01,
      borderStyle: 'solid',
      borderWidth: 1,
...
var surface = colors.colors.surface,
...
var surface$1 = colors.colors.surface;
var outlined = {
  default: {
    $all: {
      main: {
...
var itemHeader = {
  main: {
    $all: {
      position: 'relative',
      justifyContent: 'center',
      backgroundColor: jsutils.get(colors.colors, 'surface.primary.colors.dark'),
      width: '100%',
      flexDirection: 'row',
      height: 60
    },
...
var defaults$6 = colors.getThemeDefaults();
...
var checkboxDefault = {
  ...
  content: {
    ...
    area: {
      off: {
        $all: {
          backgroundColor: jsutils.get(colors.colors, 'palette.gray01')
        },
        $web: {
          outline: 'none',
          height: '100%',
          width: '100%',
          position: 'absolute',
          boxShadow: "inset 0px 0px 5px ".concat(jsutils.get(colors.colors, 'opacity._15')),
          borderRadius: jsutils.get(defaults$6, 'form.border.radius', 5)
        }
      },
      on: {
        $all: {
          backgroundColor: jsutils.get(colors.colors, 'surface.primary.colors.main')
        }
      }
    },
    indicator: {
      off: {
        $web: {
          color: jsutils.get(colors.colors, 'palette.white02')
        }
      },
      on: {}
    },
...
var defaults$7 = colors.getThemeDefaults();
var sharedForm = {
  inputs: {
    backgroundColor: colors.colors.palette.white01,
    minWidth: 100,
  ...
  border: {
    borderRadius: 5,
    borderWidth: 1,
    borderTopColor: "".concat(colors.colors.palette.gray01),
    borderLeftColor: "".concat(colors.colors.palette.gray01),
    borderRightColor: "".concat(colors.colors.palette.gray01),
    borderBottomColor: "".concat(colors.colors.palette.gray02),
    borderStyle: 'solid'
  }
};
  ...
  default: {
    ...
    select: {
      $web: _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, sharedForm.inputs), {}, {
        borderWidth: 0,
        appearance: 'none',
        backgroundColor: colors.colors.palette.transparent
      })
    },
    icon: {
      container: {
        color: colors.colors.opacity._85,
        position: 'absolute',
        zIndex: 1,
        right: 10,
        top: 10,
      ...
      disabled: {
        color: colors.colors.opacity._30
      }
    }
  }
};

var defaults$8 = colors.getThemeDefaults();
  ...
  content: {
    ...
    indicator: {
      off: {
        $web: _rollupPluginBabelHelpers._objectSpread2({
          outline: 'none',
          backgroundColor: jsutils.get(colors.colors, 'palette.white02'),
          borderRadius: jsutils.get(defaults$8, 'form.border.radius', 5) * 2,
          boxShadow: "0px 1px 3px ".concat(jsutils.get(colors.colors, 'opacity._50')),
          marginLeft: 0,
          cursor: 'pointer',
          height: height$1,
          width: width$1,
      ...
      on: {
        $web: {
          left: width$1,
          boxShadow: "1px 1px 3px ".concat(jsutils.get(colors.colors, 'opacity._50')),
          backgroundColor: jsutils.get(colors.colors, 'surface.primary.colors.main')
        }
      }
    },
...
var defaults$9 = colors.getThemeDefaults();
...
var typography = {
  ...
  caption: _rollupPluginBabelHelpers._objectSpread2({
    color: colors.colors.opacity._60,
    fontSize: 12,
    letterSpacing: 0.4
