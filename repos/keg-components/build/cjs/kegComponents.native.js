...
var KegText = function KegText(element) {
  return reTheme.withTheme(function (props) {
    ...
    return React__default.createElement(reactNative.Text, _extends({}, attrs, {
...
var Element = React__default.forwardRef(function (_ref, ref) {
  ...
  return React__default.createElement(Touchable, _extends({}, elProps, props, {
    ref: ref
  }), children);
});
...
Button.propTypes = _objectSpread2({}, reactNative.TouchableOpacity.propTypes, {
  children: PropTypes.oneOfType([PropTypes.object, PropTypes.string, PropTypes.array, PropTypes.func]),
  disabled: PropTypes.bool,
  onClick: PropTypes.func,
  onPress: PropTypes.func,
...
var Input = reTheme.withTheme(function (props) {
  var theme = props.theme,
      children = props.children,
      style = props.style,
      onClick = props.onClick,
  ...
  return React__default.createElement(reactNative.TextInput, _extends({}, args, {
    style: theme.join(jsutils.get(theme, ['form', 'input', 'default']), style),
...
var Icon = function Icon(props) {
  return React__default.createElement(IconWrapper, props);
};
