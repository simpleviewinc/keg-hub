import { e as _extends, d as _objectWithoutProperties, b as _slicedToArray, _ as _objectSpread2 } from './_rollupPluginBabelHelpers-b6f65682.js';
import React, { createElement, forwardRef, useState, useCallback, useImperativeHandle, useMemo } from 'react';
...
var SideComponent = function SideComponent(_ref2) {
  ...
  return isStr(Component) ? React.createElement(Text, _extends({
    className: className,
    style: style
...
var ChildrenComponent = function ChildrenComponent(_ref3) {
  ...
  return React.createElement(React.Fragment, null, renderFromType(children, {
    className: className
  }, null));
};
...
var CheckboxWrapper = forwardRef(function (props, ref) {
  ...
  var ChildrenView = children && React.createElement(View, {
  ...
  return ChildrenView || React.createElement(View, {
    className: typeClassName,
    style: activeStyles.main
    ...
    styles: activeStyles.content,
    CheckIcon: CheckIcon
  }, getChecked(isWeb, isChecked), pressHandlerProp)), RightComponent && React.createElement(SideComponent, {
...
//# sourceMappingURL=checkbox.wrapper-8d69b5ad.js.map
