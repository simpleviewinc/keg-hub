...
export const BaseHeader = props => {
  ...
  const [headerStyles] = useThemePath(themePath || `header.baseHeader`, styles)
  // builds the left, center, and right section based on props

  return (
    <View
      dataSet={dataSet?.main || BaseHeader.dataSet.main}
      {...elprops}
      style={theme.join(
        headerStyles.main,
    ...
    >
      { children || (
        <>
          <Side
            dataSet={dataSet?.content?.left || BaseHeader.dataSet.content.left}
          ...
          <Center
            dataSet={
              dataSet?.content?.center || BaseHeader.dataSet.content.center
            }
            ellipsis={ellipsis}
            theme={theme}
          ...
          <Side
            right
            dataSet={
              dataSet?.content?.right || BaseHeader.dataSet.content.right
            }
            styles={headerStyles.content}
            iconName={rightIcon}
