...
var buildDataSet = function buildDataSet(current, config, key, value) {
  ...
  var built = generateDataSet(web, value, custom, _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, config), {}, {
    selector: selector
  }));
  ...
  return {
    cssProps: cssProps,
    web: web && _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, web), built.web)
  };
};
...
//# sourceMappingURL=generateDataSet-27db500b.js.map
