...
var canUseDOM = hasDomAccess.hasDomAccess();
var HeadElement = function HeadElement(props) {
  var Tag = props.tag,
      style = props.style,
      id = props.id,
      tagProps = hasDomAccess._objectWithoutProperties(props, ["tag", "style", "id"]);
  ...
  return React__default.createElement(headContext.Consumer, null, function (headTags) {
    ...
    return canUseDOM && headTags.shouldRender(Tag, indexRef.current, id) && ReactDOM.createPortal( React__default.createElement(Tag, hasDomAccess._extends({}, tagProps, {
      id: id,
      children: children
    })), document.head);
  });
...
var Title = function Title(props) {
  return React__default.createElement(HeadElement, hasDomAccess._extends({
    tag: "title"
  }, props));
};
...
var HeadProvider = function (_Component) {
  hasDomAccess._inherits(HeadProvider, _Component);
  var _super = hasDomAccess._createSuper(HeadProvider);
  function HeadProvider() {
    var _this;
    hasDomAccess._classCallCheck(this, HeadProvider);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _super.call.apply(_super, [this].concat(args));
    _this.ids = new Map();
    _this.canUseDOM = hasDomAccess.hasDomAccess();
    _this.state = {
  ...
  hasDomAccess._createClass(HeadProvider, [{
    key: "render",
