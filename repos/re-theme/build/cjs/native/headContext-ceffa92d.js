...
var mergePlatformOS = function mergePlatformOS(theme, platforms) {
  ...
  return toMerge.length ? jsutils.deepMerge.apply(void 0, hasDomAccess._toConsumableArray(toMerge)) : theme;
};
var updatePlatformTheme = function updatePlatformTheme(platforms, Platform, themeData) {
  ...
  var $class = themeData.$class,
      ...
      cleanTheme = hasDomAccess._objectWithoutProperties(themeData, ["$class", "$className"]);
...
var getTheme = function getTheme() {
  ...
  return jsutils.deepMerge.apply(void 0, hasDomAccess._toConsumableArray(sources.reduce(function (toMerge, source) {
...
var joinTheme = function joinTheme(arg1, arg2) {
  ...
  sources = !jsutils.isArr(arg2) ? [arg2].concat(sources) : [].concat(hasDomAccess._toConsumableArray(arg2.map(function (arg) {
    return jsutils.isObj(arg) && arg || arg && jsutils.get(arg1, arg);
  })), hasDomAccess._toConsumableArray(sources));
  return hasManyFromTheme(arg1) ? getTheme.apply(void 0, hasDomAccess._toConsumableArray(sources)) : getTheme.apply(void 0, [arg1].concat(hasDomAccess._toConsumableArray(sources)));
};
...
var joinThemeSizes = function joinThemeSizes(theme, sizeKey) {
  ...
  extraTheme].concat(hasDomAccess._toConsumableArray(sizesToMerge.reduce(function (themes, key) {
...
var buildTheme = function buildTheme(theme, width, height, defaultTheme, usrPlatform) {
  ...
  var _getSize = getSize(width),
      _getSize2 = hasDomAccess._slicedToArray(_getSize, 2),
      key = _getSize2[0],
      size = _getSize2[1];
  ...
  var $xsmall = mergedTheme.$xsmall,
      ...
      extraTheme = hasDomAccess._objectWithoutProperties(mergedTheme, ["$xsmall", "$small", "$medium", "$large", "$xlarge"]);
...
//# sourceMappingURL=headContext-ceffa92d.js.map
