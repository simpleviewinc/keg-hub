 ...
 * @property {Object} screen - the window size properties of the browser
...
/**
 * Builds and configures the chrome web driver
...
/**
 * Builds and configures the firefox web driver
 * @param {DriverOptions} options - options to configure the driver
 * @returns {Object} - the built driver
 */
...
/**
 * Builds the browser drivers, configured by the passed in options
