...
const toRgb$1 = (red, green, blue, alpha) => {
  const obj = jsutils.isObj(red) ? red : {
    r: red,
    g: green,
    b: blue,
    a: alpha
...
const opacity = mapOpacity((amount, color) => {
  return jsutils.isStr(color) && color.indexOf('#') === 0 ? hexToRgba(color, amount) : jsutils.isObj(color) ? toRgb(color, amount) : `rgba(${color || '0,0,0'}, ${amount})`;
});
...
const transition = (props = [], speed = 250, timingFunc = 'ease') => {
  speed = jsutils.isNum(speed) ? `${speed}ms` : jsutils.isStr(speed) ? speed : `250ms`;
  return jsutils.isStr(props) ? {
...
exports.hexToRgba = hexToRgba$1;
exports.opacity = opacity;
exports.shadeHex = shadeHex;
exports.toRgb = toRgb$1;
exports.transition = transition;
//# sourceMappingURL=transition-928d6430.js.map
