...
describe('intersectKeys', () => {
  ...
  it('should return an array of objects', () => {
    const resp = Obj.intersectKeys({ 1: 'match', 2: 'non-matching' }, [ 1 ])
  ...
  it('should split the matching and and non-matching keys into two objects', () => {
    const [matching, nonMatching] = Obj.intersectKeys(testObj, [ 0, 1 ])
  ...
  it('should return no matching keys when the second argument is not passed', () => {
    const [matching, nonMatching] = Obj.intersectKeys(testObj)
  ...
  it('should return empty objects when the first argument is not an object', () => {
    const [matching, nonMatching] = Obj.intersectKeys([], [ 0, 1 ])
  ...
  it('should work with strings and numbers', () => {
    const [matching, nonMatching] = Obj.intersectKeys(
